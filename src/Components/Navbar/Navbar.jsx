...
export default function Navbar() {
    ...
    return <>
        <div className=" w-full h-[70px]    ">
            ...
            <div >
                <ul onClick={navHandel} className={nav ? " bg-white shadow-xl  md:hidden top-[70px] left-0 w-full flex-col flex items-center text-lg py-4 font-semibold absolute min-color border-t border-[#695AA6]  z-50" : " hidden left-[-100%] ease-in"}>
                    <li className=' py-2'>
                        <a href="#home"> Home</a>
                    </li>
                    <li className=' py-2'>
